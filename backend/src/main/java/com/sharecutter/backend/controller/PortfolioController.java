...
public class PortfolioController {
    ...
    private final PortfolioHoldingsCreationService
    ...
    public PortfolioController(
        ...
        this.portfolioHoldingsCreationService =
                portfolioHoldingsCreationService;
    }
    ...
    renamePortfolio(
            ...
            @Valid
            @RequestBody
            PortfolioRenameRequest request
    ) {
    ...
    updatePortfolioValue(
            ...
            @Valid
            @RequestBody
            PortfolioValueUpdateRequest request
    ) {
        PortfolioEntity updatedPortfolio =
                portfolioService
                        .updateCurrentValue(
